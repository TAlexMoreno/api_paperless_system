...
export default class PaperlessDBUtils {
    static async getNumeroExpedienteCustomFieldId(paperlessDB) {
        ...
        let customField = numeroExpedienteCustomField.rows.at(0);
        return customField;
    }
    static async getExpedientes(paperlessDB) {
        ...
        return expedientes.rows;
    }
    static async getOrphanedExpedientes(paperlessDB, serverDB) {
